...
public class sc_debug_ui : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        msg.Append("connected: ").Append(sc_connection_handler.instance.connected)
            .Append("  ").Append(sc_connection_handler.instance.client.ip).Append("  ").Append(sc_connection_handler.instance.client.port).AppendLine();
