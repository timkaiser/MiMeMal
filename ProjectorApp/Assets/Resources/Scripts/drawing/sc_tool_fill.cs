...
public class sc_tool_fill : sc_tool
{
    ...
    public override void perFrame(RenderTexture canvas, Texture uv_image, Texture2D component_mask, float mouse_x, float mouse_y, float component_id, Color drawing_color, bool is_click_start) {
